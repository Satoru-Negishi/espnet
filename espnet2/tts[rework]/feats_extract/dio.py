...
class Dio(AbsFeatsExtract):
    ...
    def forward(
        ...
        # print("BEF len(pitch):", len(pitch))
        # print("BEF pitch[0]~[20].shape", [p.shape for p in pitch])
        # print("-------")
        ...
        # print("AFT len(pitch):", len(pitch))
        # print("AFT pitch[0]~[20].shape", [p.shape for p in pitch])
        # print("-------")
        # print("durations.shape:", durations.shape)
        # print("durations[0]~[20].shape", [d.shape for d in durations])
        # print("durations[0]~[20].sum()", [d.sum() for d in durations])

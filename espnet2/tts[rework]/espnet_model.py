...
class ESPnetTTSModel(AbsESPnetModel):
    ...
    def inference(
        ...
        **decode_config,
        ...
        if (decode_config["use_teacher_forcing"] or getattr(self.tts, "use_gst", False) ) and not use_style_embedding:
            if speech is None:
        ...
        if use_style_embedding:
            input_dict.update(use_style_embedding=use_style_embedding)
